...
// class Defender {
//   constructor(xProcentai, yProcentai, plotis = 50, aukstis = 50, dmg = 20, reloudTime = 1, img = "default_soldier.png") {
//     this.xProcentai = xProcentai;
//     this.yProcentai = yProcentai;
//     this.plotis = plotis;
...
//   get x() {
//     return (this.xProcentai / 100) * ePlotis;
//   }

//   get y() {
//     return (this.yProcentai / 100) * eAukstis;
//   }
// }
